...
export default function Home() {
  ...
  const { isLoading, isError, data, error } = useQuery(
    ['new-york-photos', page],
    () => fetchPhotos('new york', 9, page, 't5WxxhORJ7sAw_rEMQVskzTEdzMq4sLKhHWhk99FqSQ'),
  ...
  return (
    <>
      <Layout>
        <Head>
          <title>New York | Tour De World</title>
        ...
        <main className='min-h-screen layout py-24'>
          <div className='flex items-center'>
            <h1 className='text-[64px] text-center'>New York</h1>
