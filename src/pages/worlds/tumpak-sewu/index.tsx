...
export default function Home() {
  ...
  const { isLoading, isError, data, error } = useQuery(
    ['tumpak-sewu-photos', page],
    () => fetchPhotos('tumpak sewu', 9, page, 't5WxxhORJ7sAw_rEMQVskzTEdzMq4sLKhHWhk99FqSQ'),
  ...
  return (
    <>
      <Layout>
        <Head>
          <title>Tumpak Sewu | Tour De World</title>
        ...
        <main className='min-h-screen layout py-24'>
          <div className='flex items-center'>
            <h1 className='text-[64px]'>Tumpak Sewu</h1>
