      ...
      <Layout>
        ...
        <main className='layout min-h-screen pt-20'>
          <Image
            ...
            width={300}
            height={800}
            className='fixed -z-10 right-8 -bottom-32 lg:w-[500px]'
          />
          {/* <BackgroundImage
            alt='blob'
          ...
          <Image
            ...
            width={700}
            height={800}
            className='fixed -z-10 top-28 -left-24 lg:w[800px]'
          />
          <Image
            alt='blob'
            src='/blobsm.svg'
            width={1400}
            height={800}
            className='fixed -z-20 top-12 lg:w[800px]'
          />
