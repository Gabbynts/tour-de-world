      ...
      <Layout>
        ...
        <main className='layout min-h-screen pt-20'>
          ...
          <div className='flex relative flex-col p-12 rounded-[12px] pt-6 items-center'>
            <Typography sizeVariant='h' colorVariant='primary' className='text-center pb-14'>
              Share Your Experiences
            </Typography>
            <div className='flex flex-col pt-20 pb-9 border-[3px] bg-[#1C0737]/70 border-[#AB7AE2] rounded-[18px] w-[500px] items-center'>
              <RiUser3Fill className='absolute w-[70px] h-[70px] top-[135px] z-10 text-[#FFF6FF]' />
              <div className='absolute border-[3px] border-[#AB7AE2] rounded-full w-[90px] h-[90px] bg-[#260D45] top-32'></div>
              <FormProvider {...methods}>
                ...
                >
                  ...
                  <button
                    type='submit'
                    className='bg-[#AB7AE2] rounded-xl p-3 hover:bg-[#493b5c]'
                  >
                    Submit
                  </button>
                  {showSuccessModal && (
